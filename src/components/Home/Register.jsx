...
const Register = ({navigation}) => {
  ...
  const registerUser = async () => {
    // try {
    //   setLoading(true);
    //   const response = await fetch("https://klick-api.onrender.com/auth/signup", {
    //     method:"POST",
    ...
    //     await AsyncStorage.setItem('token', _data.access_token);
    ...
    //     // Alert.alert('Register Succesfully', errorData.message, );
    //     // navigate
    //   // }
    // } catch (error) {
